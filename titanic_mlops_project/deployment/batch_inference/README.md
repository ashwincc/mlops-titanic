# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [titanic_mlops_project/resources/README.md](../../resources/README.md)
...
df.write.mode("overwrite").saveAsTable(
    name="<catalog>.titanic-mlops-project.feature_store_inference_input"
)
```

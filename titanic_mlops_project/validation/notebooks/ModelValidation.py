...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``titanic_mlops_project/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in titanic-mlops-project/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in titanic-mlops-project/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-titanic-mlops-project-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.titanic-mlops-project.titanic-mlops-project-model", "Full (Three-Level) Model Name")

...
Opening a pull request will trigger a[workflow](../.github/workflows/titanic-mlops-project-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/staging-titanic-mlops-project-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/prod-titanic-mlops-project-model)
